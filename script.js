        ...
        const options = {
            ...
            myself: "Who's responsible",
            halt: "Put a stop to",
            eat: "When hungry",
            robot: "An AI",
            chaos: "Total disorder",
            shuffle: "Mix up",
            chicken: "Bird can't fly",
            combine: "Add",
        ...
        const inpSection = document.getElementById("input-section");
        ...
        const blocker = () => {
            const lettersButtons = document.querySelectorAll(".letters");
        ...
        const generateWord = () => {
            ...
            inpSection.innerHTML = displayItem;
            inpSection.innerHTML += `<div id='chanceCount'>Chances Left: ${lossCount}</div>`;
        };
